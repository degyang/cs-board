...
def render_manifest_document(task_id: str, run_id: str, timeline: dict[str, Any], illustrations: dict[str, Any], fps: int = 30) -> dict[str, Any]:
    ...
    return {**_metadata("render-manifest", "render.manifest", task_id, run_id, "render-visuals", Engine.WHITEBOARD), "renderer": "whiteboard", "canvas": {"width": 1920, "height": 1080}, "fps": fps, "clips": clips}
