...
def storyboard_document(task_id: str, run_id: str, units: tuple[VoiceUnit, ...], style_profile: str = "whiteboard-default") -> dict[str, Any]:
    ...
    return {**_metadata("storyboard", "planning.storyboard", task_id, run_id, "plan-storyboard", Engine.WHITEBOARD), "visuals": visuals}
