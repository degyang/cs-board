...
def mountain_settings_router(
    ...
    def get_storage():
        assets_dir = data_dir / "settings" / "assets"
        tasks_dir = data_dir / "outputs"
        temp_dir = data_dir / "outputs" / "temp"

        try:
            test_file = data_dir / "settings" / "write-test.tmp"
    ...
    def get_diagnostics():
        ...
        for task_dir in sorted((data_dir / "outputs").glob("*/runs/*/observability"), reverse=True)[:5]:
