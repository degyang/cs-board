...
def test_create_options_are_server_owned_and_mark_unavailable_paths(tmp_path):
    ...
    assert body["defaults"] == {"engine": "whiteboard", "visual_source": "preset", "target_chars": 45, "shots_per_image": 2, "line_density": "rich", "visual_anchor_enabled": True, "include_subtitles": True}
    assert body["limits"]["target_chars_min"] == 5
